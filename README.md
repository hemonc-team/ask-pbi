...
В Claude выберите работу **на этом компьютере** (On your computer), не в облаке. Иначе Claude не достучится до Power BI.
...
| Claude пишет, что нет интернета / облако / песочница | Новый чат, режим **на этом компьютере** |
