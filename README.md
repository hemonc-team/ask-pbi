...
Не режим **Chat** — в нём Claude не видит файлы на компьютере.

Нужен **Cowork** и работа **на этом компьютере** (On your computer), не облако. При запросе доступа разрешите папку `ask-pbi`.
